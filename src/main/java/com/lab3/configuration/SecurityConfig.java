...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/nurse/**").hasRole("NURSE")
                .antMatchers(HttpMethod.GET, "/patient/**").hasRole("PATIENT")
                .antMatchers(HttpMethod.POST,"/doctor/**").hasRole("DOCTOR")
                .antMatchers(HttpMethod.POST, "/nurse/**").hasRole("NURSE")
                .antMatchers(HttpMethod.POST, "/patient/**").hasRole("PATIENT")
                .antMatchers(HttpMethod.GET, "/me_info").hasAnyRole("PATIENT", "NURSE", "DOCTOR")
